...
// Выполнить тестовое подключение к сайту.
// 
// Параметры:
//  НастройкаИнтеграции - СправочникСсылка.НастройкиИнтеграцииСИнтернетМагазином - Настройка интеграции
// 
// Возвращаемое значение:
//  Структура - Выполнить тестовое подключение к сайту:
// * Результат - Булево - 
// * Текст - Строка - 
...
// Выполнить подключение к сайту.
// 
// Параметры:
//  НастройкаИнтеграции - СправочникСсылка.НастройкиИнтеграцииСИнтернетМагазином - Настройка интеграции
// 
// Возвращаемое значение:
//  Структура - Выполнить подключение к сайту:
// * Результат - Булево - 
// * Текст - Строка - 
// * Соединение - Неопределено - 
...
// Загрузить настройки битрикс.
// 
// Параметры:
//  НастройкаИнтеграции - Структура - Настройка интеграции
// 
// Возвращаемое значение:
//  Строка, Неопределено - Загрузить настройки битрикс
...
// Загрузить настройки UMI.
// 
// Параметры:
//  НастройкаИнтеграции - Структура - Настройка интеграции
// 
// Возвращаемое значение:
//  Строка, Неопределено - Загрузить настройки UMI
...
//
// Параметры:
//	ЗначениеXDTO - СписокXDTO, ОбъектXDTO - список XDTO, объекты которого нужно получить
//
// Возвращаемое значение:
//	Массив из ОбъектXDTO - массив свойств объекта XDTO.
//
Функция ПолучитьМассивОбъектовСпискаXDTO(ЗначениеXDTO) Экспорт
	
	МассивОбъектовXDTO = Новый Массив;
	
	Если ТипЗнч(ЗначениеXDTO) = Тип("СписокXDTO") Тогда
		
		Для Каждого ОбъектXDTO Из ЗначениеXDTO Цикл 
			МассивОбъектовXDTO.Добавить(ОбъектXDTO);
		КонецЦикла;
		
	Иначе
		МассивОбъектовXDTO.Добавить(ЗначениеXDTO);
	КонецЕсли;
...
// Объект XDTOСодержит свойство.
// 
// Параметры:
//  ОбъектXDTO - ЗначениеXDTO, Произвольный, ОбъектXDTO, Неопределено - Объект XDTO
//  Свойство - Строка - Свойство
// 
// Возвращаемое значение:
//  Булево - Объект XDTOСодержит свойство
...
// Свойство XDTOЗаполнено.
// 
// Параметры:
//  СвойствоXDTO - Строка - Свойство XDTO
// 
// Возвращаемое значение:
//  Булево - Свойство XDTOЗаполнено
...
//  Дополнение - Строка, Неопределено - Дополнение
...
// Найти создать номенклатуру.
// 
// Параметры:
//  ТоварXDTO - ОбъектXDTO, Произвольный - Товар XDTO
//  ЭтоУслуга - Булево - Это услуга
//  Параметры - Структура - Параметры
//  СтавкаНДС - Неопределено, СправочникСсылка.СтавкиНДС - Ставка НДС
//  ОписаниеОшибки - Строка - Описание ошибки
// 
// Возвращаемое значение:
//  СправочникСсылка.Номенклатура, Неопределено, Произвольный - Найти создать номенклатуру
	...
	Если ОбъектXDTOСодержитСвойство(ТоварXDTO, "Ид") И СвойствоXDTOЗаполнено(ТоварXDTO.Ид) Тогда
		...
		Если СтрДлина(ИдНоменклатуры)=СтрДлина(Новый УникальныйИдентификатор) Тогда //Уникальный идентификатор 1С
			...
			Исключение
				...
				НСтр("ru = 'Не удалось выполнить поиск номенклатуры по уникальному идентификатору:'")
				+ " " + ТоварXDTO.Ид));
...
// Ссылка соответствие по ид.
// 
// Параметры:
//  ИдОбъекта - Строка - Ид объекта
//  ТипОбъекта - Строка - Тип объекта
//  НастройкаИнтеграции - СправочникСсылка.НастройкиИнтеграцииСИнтернетМагазином - Настройка интеграции
// 
// Возвращаемое значение:
//  Неопределено - Ссылка соответствие по ид
...
// Найти создать характеристику номенклатуры.
// 
// Параметры:
//  ТоварXDTO - ОбъектXDTO, Произвольный - Товар XDTO
//  ЭтоУслуга - Булево - Это услуга
//  Номенклатура - Произвольный, Неопределено, СправочникСсылка.Номенклатура - Номенклатура
//  Параметры - Структура - Параметры:
//  ОписаниеОшибки - Строка - Описание ошибки
// 
// Возвращаемое значение:
//  Неопределено, СправочникСсылка.ХарактеристикиНоменклатуры - Найти создать характеристику номенклатуры
...
// Распаковать ZIPАрхив.
// 
// Параметры:
//  СтрокаZIP - Неопределено, Строка - Строка ZIP
//  ОписаниеОшибки - Строка - Описание ошибки
// 
// Возвращаемое значение:
//  Строка - Распаковать ZIPАрхив
...
// Получить заказы веб сервис.
// 
// Параметры:
//  ДатаИзменения - Дата - Дата изменения
//  КодНастройкиИнтеграции - Неопределено - Код настройки интеграции
// 
// Возвращаемое значение:
//  Неопределено, ОбъектXDTO - Получить заказы веб сервис
...
// Загрузить заказы веб сервис.
// 
// Параметры:
//  ДанныеЗаказовXDTO - СписокXDTO -Данные заказов XDTO
//  КодНастройкиИнтеграции - Неопределено - Код настройки интеграции
// 
// Возвращаемое значение:
//  Строка, Булево - Загрузить заказы веб сервис
...
// Получить классификатор и каталог веб сервис.
// 
// Параметры:
//  ДатаИзменения - Дата - Дата изменения
//  КодГруппы - Строка - Код группы
//  КодНастройкиИнтеграции - Неопределено - Код настройки интеграции
// 
// Возвращаемое значение:
//  ОбъектXDTO - Получить классификатор и каталог веб сервис
...
// Получить остатки и цены веб сервис.
// 
// Параметры:
//  ДатаИзменения - Дата - Дата изменения
//  КодГруппы - Строка - Код группы
//  КодСклада - Строка - Код склада
//  КодОрганизации -Строка - Код организации
//  КодНастройкиИнтеграции - Строка, Неопределено - Код настройки интеграции
// 
// Возвращаемое значение:
//  ОбъектXDTO - Получить остатки и цены веб сервис
...
// Получить картинку веб сервис.
// 
// Параметры:
//  ИдентификаторТовараСтрока - Строка - Идентификатор товара строка
// 
// Возвращаемое значение:
//  Неопределено, ЗначениеXDTO, ОбъектXDTO - Получить картинку веб сервис
...
// Создать обновить регламентное задание обмена.
// 
// Параметры:
//  НастройкаИнтеграции - СправочникСсылка.НастройкиИнтеграцииСИнтернетМагазином - Настройка интеграции
//  ЗаписатьНастройку - Булево - Записать настройку
//  ОбновитьРасписание - Булево - Обновить расписание
//  ОписаниеНастроек - Неопределено - Описание настроек
// 
// Возвращаемое значение:
//  Неопределено, УникальныйИдентификатор - Создать обновить регламентное задание обмена
...
// Удалить регламентное задание обмена.
// 
// Параметры:
//  НастройкаИнтеграции - СправочникСсылка.НастройкиИнтеграцииСИнтернетМагазином - Настройка интеграции
...
// Есть регламентное задание обмена.
// 
// Параметры:
//  НастройкаИнтеграции - СправочникСсылка.НастройкиИнтеграцииСИнтернетМагазином - Настройка интеграции
//  ИдентификаторРегламентногоЗадания - Строка - Идентификатор регламентного задания
// 
// Возвращаемое значение:
//  Булево - Есть регламентное задание обмена
...
//
// Параметры:
//	НастройкиПрокси		- Соответствие из Строка -
//					ключи:
...
//	НастройкиПодключения - Структура - Структура настроек подключения к сайту
...
//
// Параметры:
//	Объект - Произвольный - произвольный ссылочный тип
...
Функция СформироватьУникальныйИдентификаторОбъекта(Объект, Характеристика = Неопределено)
	...
	Попытка
		...
		Идентификатор = Строка(Объект.УникальныйИдентификатор());
		
		Если ЗначениеЗаполнено(Характеристика)
			И ТипЗнч(Объект) = Тип("СправочникСсылка.Номенклатура") Тогда
			
			ОбъектЭтоГруппа = ОбщегоНазначения.ЗначениеРеквизитаОбъекта( Объект, "ЭтоГруппа" );
			Если (НЕ ОбъектЭтоГруппа) Тогда
			
				Идентификатор = Идентификатор + "#" + Строка(Характеристика.УникальныйИдентификатор());
...
Функция ПолучитьДанныеССервера( Соединение, АдресРесурса, Заголовки, ОписаниеОшибки, Параметры = Неопределено )
	...
	Если HTTPОтветСервера.КодСостояния <> 200 Тогда
		...
		Иначе
			...
			Если СтрНайти( ВРЕГ( ОтветСервера ), "<!DOCTYPE HTML" ) > 0 Тогда
	...
	ИначеЕсли СтрНайти(ОтветСервера, "�") > 0 Тогда
		...
		Если СтрНайти(ОтветСервера,"�")>0 Тогда
			ДобавитьОписаниеОшибки(ОписаниеОшибки, 
			НСтр("ru = 'Отправка файла на сервер: Не удалось прочитать ответ сервера в указанной кодировке'") + ContentType);
		КонецЕсли;
	КонецЕсли;
...
Функция ПолучитьИдНоменклатуры(Знач Идентификатор)
	
	ПозицияРазделителя = СтрНайти(Идентификатор, "#");
	Если ПозицияРазделителя > 0 Тогда
		ИдНоменклатуры = Лев(Идентификатор, ПозицияРазделителя - 1);
	Иначе
		ИдНоменклатуры = Идентификатор;
	КонецЕсли;
...
Функция ПолучитьИдХарактеристики(Знач Идентификатор)
	
	ПозицияРазделителя = СтрНайти(Идентификатор, "#");
	Если ПозицияРазделителя > 0 Тогда
		ИдХарактеристики = Сред(Идентификатор, ПозицияРазделителя + 1);
	Иначе
		ИдХарактеристики = "";
	КонецЕсли;
...
//
// Параметры:
//	КодНастройкиИнтеграции- Строка - строка с кодом узла плана обмена.
//
...
Процедура ДобавитьОшибкуВСчетчикРегламентногоЗаданияИОтключитьПриПревышенииСУведомлением(НастройкаИнтеграции, ДатаИнтеграции, ТекстОшибки)
	...
	МенеджерЗаписи = РегистрыСведений.СчетчикОшибокРегламентногоЗаданияИнтернетМагазина.СоздатьМенеджерЗаписи();
	МенеджерЗаписи.НастройкаИнтеграции = НастройкаИнтеграции;
	МенеджерЗаписи.ДатаНачала = ДатаИнтеграции;
...
Процедура СчетчикОшибокРегламентногоЗаданияОчистить( НастройкаИнтеграции )
	НаборЗаписей = РегистрыСведений.СчетчикОшибокРегламентногоЗаданияИнтернетМагазина.СоздатьНаборЗаписей();
...
Процедура СоздатьОтправитьЭлектронноеПисьмо(НастройкаИнтеграции, ТемаПисьма, ТелоПисьма)
	...
	Исключение
		...
		ТекстСообщенияШаблон = НСтр( "ru = 'Ошибка отправки электронного письма.
		| %1'" );
		ТекстСообщения = СтрШаблон( ТекстСообщенияШаблон, ТекстОшибки);
...
//
// Параметры:
//   ПараметрыОбмена - Структура - структура с параметрами обмена с сайтом
...
//
// Параметры:
//	НастройкаИнтеграции	- СправочникСсылка.НастройкиИнтеграцииСИнтернетМагазином, Структура -
//	Параметры - Структура - 
...
Функция ПолучитьФайлыОбмена(НастройкаИнтеграции, ВыгружатьТолькоИзменения = Истина, ПараметрыКонтекст = Неопределено) Экспорт
	...
	Если Параметры.ОбменТоварами Тогда 
		...
		Для Каждого СтрокаТаблицыКаталогов Из ТаблицаКаталогов Цикл
			...
			Новый Структура("ВыгруженоТоваров,ВыгруженоКартинок,ВыгруженоФайлов", 0, 0, 0);
			СтрокаТаблицыКаталогов.СтруктураРезультата.Вставить( "ВыгруженоПредложений", 0 );
			СтрокаТаблицыКаталогов.СтруктураРезультата.Вставить( "ОписаниеОшибки", "" ); 
...
//
// Возвращаемое значение:
//	Массив из ДокументСсылка.ЗаказПокупателя - Массив заказов покупателей.
//
...
//	СтрокаТаблицыИнформации	- СтрокаТаблицыЗначений - Строка таблицы значений
//
...
Функция ПодготовитьДанныеXDTOКлассификаторИКаталог(Параметры, ПакетCML)
	...
	Исключение
		...
		Иначе
			ТекстОшибки = ТекстОшибки + ОбработкаОшибок.ПодробноеПредставлениеОшибки( ИнформацияОбОшибке());
		КонецЕсли;
		ОбщегоНазначения.СообщитьПользователю( ТекстОшибки );
...
//
// Параметры:
//	КаталогXDTO - ОбъектXDTO - типа Каталог
//	ПакетCML - ПакетXDTO - 
//	Параметры - структура - Содержит параметры обмена.
//
...
//
// Параметры:
//	ПакетПредложенийXDTO - ОбъектXDTO - объект XDTO типа ПакетПредложений
//	ПакетCML - ПакетXDTO - пакет XDTO
//	Параметры - Структура - содержащая параметры обмена.
//	ИмяПакетаПредложений - Строка - 
//
...
//
// Возвращаемое значение:
//	Булево - Истина, если выгрузка завершилась без ошибок.
//
...
// Параметры:
//	Параметры				- Структура - основные параметры
//	СтрокаТаблицыИнформации	- СтрокаТаблицыЗначений - 
//	ИмяПакета - Строка - 
//
...
Функция ГруппыНоменклатурыXDTOРекурсия(ТаблицаГрупп, ПакетCML, Идентификатор = "")
	...
	ОтборПоиск = Новый Структура("РодительИдентификатор", Идентификатор);
	РезультатПоиска = ТаблицаГрупп.НайтиСтроки(ОтборПоиск);
	
	Для Каждого СтрокаДерева Из РезультатПоиска Цикл
...
Процедура ЗаполнитьГруппыКлассификатораXDTO(ГруппыКлассификатораXDTO, ДеревоГрупп, 
	СписокГрупп, ПакетCML, ТекущийРодитель = Неопределено, Параметры)
...
//	СписокГрупп - СписокЗначений из Произвольный - группы выгружаемого каталога
//	ПакетCML - Произвольный - 
...
//
// Параметры:
//	КлассификаторXDTO - ОбъектXDTO - объект XDTO типа Классификатор
//	ПакетCML - ПакетXDTO - пакет XDTO
//	ВыборкаСвойствНоменклатуры - Произвольный - Выборка, содержащая свойства Номенклатуры.
//	Параметры - Структура -
//
...
//
// Параметры:
//	ТоварыXDTO - ОбъектXDTO - типа Товары
//	ПакетCML - ПакетXDTO - 
...
//
// Параметры:
//	Параметры - Структура - структура настроек, в которой есть Выборка товаров с нужными полями
//	ИмяПоля - Строка - имя поля Товара в формате обмена CommerceML , которое нужно вернуть
//	ЗначениеПоУмолчанию - Произвольный - Значение, которое возвращается, если настройки не заданы
//
...
//
// Параметры:
//	ТоварXDTO - ОбъектXDTO - типа Товар
//	ТаблицаФайлов - ТаблицаЗначений - содержащая пути к файлам
//	Параметры - Структура - содержащая параметры обмена
//	ОписанияФайлов - Массив из Произвольный - ключом которого является пути к файлу, а значением описание файла.
//	ОписанияКартинок - Произвольный -
//
...
//
// Параметры:
//	ДанныеФайла - Структура - структура, содержащая информацию по изображению
//	Параметры - Структура - структура, содержащая данные по обмену
//	ОписаниеОшибки - Строка - строка для записи информации об ошибках
//	ВладелецКартинок - Произвольный - 
//	
// Возвращаемое значение:
...
// Параметры:
//	ТоварXDTO - ОбъектXDTO - типа Товар
//	ТаблицаСвойств - ТаблицаЗначений - содержащая значения свойств номенклатуры
//	Параметры - Структура - содержащая параметры обмена
//	ПакетCML - Произвольный - пакет XDTO.
//
...
//
// Параметры:
//	ПакетПредложенийXDTO - ОбъектXDTO - типа ПакетПредложений
//	ПакетCML - ПакетXDTO -
//	Параметры - Структура - структура, содержащая параметры обмена.
//
...
//
// Параметры:
//	ПредложениеXDTO - ОбъектXDTO - типа Предложение
//	ПакетCML - ПакетXDTO -
//	Характеристика - Произвольный - Характеристика номенклатуры
...
//
// Параметры:
//	Параметры - Структура - Структура, основные параметры
//	ТаблицаИнформации	- ТаблицаЗначений - таблица информации о состоянии обмена
// 
// Возвращаемое значение
...
//
// Параметры:
//	ДанныеЗаказов - Произвольный - строка для записи xml или ОбъектXDTO
//	СтруктураСтатистики	- Структура
//	Параметры - Структура - Структура, основные параметры
//	ОписаниеОшибки		- Строка
//
...
Процедура СоздатьОбновитьДокументОплаты(ЗаказСсылка, СвойстваОплаты, Параметры, СтруктураСтатистики, ОписаниеОшибки)
	...
	ЗаказСсылкаЗначенияРеквизитов =
	ОбщегоНазначения.ЗначенияРеквизитовОбъекта( ЗаказСсылка, 
	"Номер, СуммаДокумента, СтоимостьДоставки, ИнформацияПоКонтрагенту, Автор" );
		...
		ИначеЕсли СвойстваОплаты.Получить("Оплачено") = "false" Тогда
			...
			Если ОперацияПоПлатежнымКартам.Проведен Тогда
				...
				Исключение
					...
					ОписаниеИсключительнойОшибки(ПодробноеПредставлениеОшибки, 
					НСтр("ru = 'Не удалось отменить проведение ОперацияПоПлатежнымКартам к заказу №'")
					+ ЗаказСсылкаЗначенияРеквизитов.Номер);
					ДобавитьОписаниеОшибки(ОписаниеОшибки, ТекстОшибки);
				КонецПопытки;
			КонецЕсли; 
	...
	ИначеЕсли НЕ Параметры.ПодчиненныеДокументы И НРег(СвойстваОплаты.Получить("Заказ оплачен")) <> "true" Тогда
		...
		Возврат;
	ИначеЕсли ЗаказСсылкаЗначенияРеквизитов.СуммаДокумента + ЗаказСсылкаЗначенияРеквизитов.СтоимостьДоставки = 0 Тогда
	...
	ДокОперацияПоПлатежнымКартамЭквайринговыйТерминалКасса = 
	ОбщегоНазначения.ЗначениеРеквизитаОбъекта( ДокОперацияПоПлатежнымКартам.ЭквайринговыйТерминал, "Касса" );
	
	ДокОперацияПоПлатежнымКартам.КассаККМ = ДокОперацияПоПлатежнымКартамЭквайринговыйТерминалКасса;
	ДокОперацияПоПлатежнымКартам.Статус = Перечисления.СтатусыЧековККМ.ЧекНеПробит;
	
	ЗаказСсылкаЗначенияРеквизитовИнформацияПоКонтрагенту = 
	ЗаказСсылкаЗначенияРеквизитов.ИнформацияПоКонтрагенту.Выгрузить();
	// Телефон и email для отправки чека
	СтрокаТЧТелефон = ЗаказСсылкаЗначенияРеквизитовИнформацияПоКонтрагенту.Найти("Телефон","Вид");
	Если СтрокаТЧТелефон=Неопределено Тогда
		СтрокаТЧТелефон = ЗаказСсылкаЗначенияРеквизитовИнформацияПоКонтрагенту.Найти(НРег("ТелефонМобильный"),"Вид");
	КонецЕсли;
	...
	СтрокаТЧEMail = ЗаказСсылкаЗначенияРеквизитовИнформацияПоКонтрагенту.Найти("email","Вид");
	Если СтрокаТЧEMail=Неопределено Тогда
		СтрокаТЧEMail = ЗаказСсылкаЗначенияРеквизитовИнформацияПоКонтрагенту.Найти("E-mail","Вид");
	КонецЕсли;
	Если СтрокаТЧEMail=Неопределено Тогда
		СтрокаТЧEMail = ЗаказСсылкаЗначенияРеквизитовИнформацияПоКонтрагенту.Найти("Адрес электронной почты","Вид");
	КонецЕсли;
	Если СтрокаТЧEMail=Неопределено Тогда
		СтрокаТЧEMail = ЗаказСсылкаЗначенияРеквизитовИнформацияПоКонтрагенту.Найти("АдресЭП","Вид");
	КонецЕсли;
	...
	Если НЕ ЗначениеЗаполнено(ДокОперацияПоПлатежнымКартам.ЭквайринговыйТерминал) Тогда
		...
		Если НастройкаПлатежныйТерминал<>Неопределено Тогда
			...
			ДокОперацияПоПлатежнымКартам.ЭквайринговыйТерминал = НастройкаПлатежныйТерминал.АналитикаОплаты;
			Если ЗначениеЗаполнено(ДокОперацияПоПлатежнымКартам.ЭквайринговыйТерминал) Тогда
				ЭквайринговыйТерминалКасса = 
				ОбщегоНазначения.ЗначениеРеквизитаОбъекта( ДокОперацияПоПлатежнымКартам.ЭквайринговыйТерминал, "Касса" );
				ДокОперацияПоПлатежнымКартам.КассаККМ = ЭквайринговыйТерминалКасса;
			КонецЕсли;
	...
	Если НЕ ЗначениеЗаполнено(ДокОперацияПоПлатежнымКартам.Автор) Тогда
		Если ЗначениеЗаполнено(ЗаказСсылкаЗначенияРеквизитов.Автор) Тогда
			ДокОперацияПоПлатежнымКартам.Автор = ЗаказСсылкаЗначенияРеквизитов.Автор;
		Иначе
	...
	Исключение
		...
		ТекстОшибки = ОписаниеОшибки() + Символы.ПС 
		+ ОписаниеИсключительнойОшибки(ПодробноеПредставлениеОшибки, 
		НСтр("ru = 'Не удалось записать ОперацияПоПлатежнымКартам к заказу №'")
		+ ЗаказСсылкаЗначенияРеквизитов.Номер);
		ДобавитьОписаниеОшибки(ОписаниеОшибки, ТекстОшибки);
	КонецПопытки;
	...
	Если УдалосьЗаписать Тогда
		...
		Если Параметры.ПодчиненныеДокументы Тогда
			...
			Если Параметры.Свойство("НастройкаИнтеграции") Тогда
				...
				НоваяЗапись.КлючИнтеграции = 
				ИнтеграцияСИнтернетМагазиномПовтИсп.ПолучитьКлючПоНастройке(Параметры.НастройкаИнтеграции);
				НоваяЗапись.УзелОбмена = 
				ИнтеграцияСИнтернетМагазиномПовтИсп.ПолучитьУзелОбменаПоНастройке(Параметры.НастройкаИнтеграции);
			КонецЕсли;
...
//
// Параметры:
//	СтрокаXML - Строка - объект чтения XML
//	Параметры - структура
//	ОписаниеОшибки - строка
//
// Возвращаемое значение:
...
//
// Параметры:
//	МассивНомеров - Массив из Строка - номера загружаемых документов
//
// Возвращаемое значение
//	Результат запроса.
//
...
//	
//Параметры:
//	ДокументыXDTO - массив из ОбъектXDTO- массив объектов XDTO
//	РанееЗагруженныеЗаказы - ТаблицаЗначений - данные по ранее загруженным заказам
//	СтруктураСтатистики - Структура - структура статистики
...
//	
//Параметры:
//	ДокументыXDTO - массив из ОбъектXDTO - 
//	РанееЗагруженныеЗаказы - ТаблицаЗначений - данные по ранее загруженным заказам
//	СтруктураСтатистики - Структура - структура статистики
//	Параметры - Структура - структура параметров
//	ОписаниеОшибки - строка - содержит описание ошибок
...
Процедура ВыполнитьДействияПередЗаписьюЗаказа(ДокументОбъект, Параметры, ЗаписыватьВсегда = Ложь)
	...
	Если ЗначениеЗаполнено(ДокументОбъект.Контрагент) Тогда
		...
		ОбщегоНазначения.ЗначениеРеквизитаОбъекта( ДокументОбъект.Контрагент, "ВестиРасчетыПоДоговорам" );
		
		Если НЕ ВестиРасчетыПоДоговорам И НЕ ЗначениеЗаполнено(ДокументОбъект.Договор) Тогда
	...
	Если УстанавливатьСкидкиИзДоговора(Параметры) Тогда
		ВидСкидкиНаценки = 
		ОбщегоНазначения.ЗначениеРеквизитаОбъекта( ДокументОбъект.Договор, "ВидСкидкиНаценки" );
		
		ДокументОбъект.ВидСкидкиНаценки = ВидСкидкиНаценки;
...
Процедура УдалитьДвиженияУДокумента(ДокументОбъект)
	...
	Для Каждого СтрокаДвижения Из МассивОбрабатываемыхСтрокТаблицыДвижений Цикл		
		...
		Исключение
			...
			ВызватьИсключение "Операция не выполнена: " + СтрокаДвижения.Имя + Символы.ПС 
...
//	СвойстваЗаказа - Соответствие из Произвольный - свойства и значения загружаемого заказа
...
Функция ЗаполнитьЗаказДаннымиДокументаXDTO(ДокументОбъект, ДокументXDTO, СвойстваЗаказа, Параметры, ОписаниеОшибки)
	...
	Если ЗначениеЗаполнено(Склад) Тогда
		...
		СкладМОЛ = ОбщегоНазначения.ЗначениеРеквизитаОбъекта( Склад, "МОЛ"); 
		Ответственный = ПолучитьМОСотрудника(СкладМОЛ);
	...
	Если ЗначениеЗаполнено(ДокументОбъект.Организация) Тогда
		ОрганизацияЗначенияРеквизитов = 
		ОбщегоНазначения.ЗначенияРеквизитовОбъекта( ДокументОбъект.Организация, 
		"БанковскийСчетПоУмолчанию, КассаПоУмолчанию" );
		
		ДокументОбъект.БанковскийСчет = ОрганизацияЗначенияРеквизитов.БанковскийСчетПоУмолчанию;
		ДокументОбъект.Касса = ОрганизацияЗначенияРеквизитов.КассаПоУмолчанию;
	Иначе
		...
		Если ПроверитьИмяСвойстваКакРеквизит(ИмяРеквизита, РазрешенныеСимволыИмениРеквизита) Тогда
			...
			Если ЕстьРеквизитИлиСвойствоОбъекта(ДокументОбъект, ИмяРеквизита) Тогда
				...
				ИначеЕсли ТипЗнч(ДокументОбъект[ИмяРеквизита]) = Тип("Число") Тогда
					...
					Исключение
						ДобавитьОписаниеОшибки(ОписаниеОшибки,
						НСтр("ru = 'Не удалось преобразовать значение свойства в число:'") + " "
						+ ИмяРеквизита+":"+элСоответствие.Значение);
					КонецПопытки; 
				ИначеЕсли ТипЗнч(ДокументОбъект[ИмяРеквизита]) = Тип("Дата") 
					...
					Исключение
						ДобавитьОписаниеОшибки(ОписаниеОшибки,
						НСтр("ru = 'Не удалось преобразовать значение свойства в дату:'") + " " 
						+ ИмяРеквизита+":"+элСоответствие.Значение);
					КонецПопытки;
				КонецЕсли;
...
Функция ЗаполнитьЗаказНарядДаннымиДокументаXDTO(ДокументОбъект, ДокументXDTO, СвойстваЗаказа, Параметры)
	...
	Если ЗначениеЗаполнено(ДокументОбъект.Контрагент)
		И ВестиРасчетыПоДоговорам Тогда
...
Функция ПроверитьИмяСвойстваКакРеквизит(ИмяРеквизита, РазрешенныеСимволыИмениРеквизита)
	...
	Номер=1;
	Пока Номер <= СтрДлина(ИмяРеквизита) Цикл
		ПроверяемыйСимвол = Сред(ИмяРеквизита, Номер, 1);
...
Функция ПолучитьНомерДокументаССайта(Знач НомерНаСайте, Организация, Параметры)
	...
	Если Параметры.ИспользоватьПрефиксОрганизации = Истина Тогда
...
//@skip-check method-optional-parameter-before-required
Функция СоздатьЗаполнитьКонтактноеЛицоКонтрагента(КонтрагентОбъект, КонтрагентXDTO, НаименованиеКонтрагента = "", 
	КонтактноеЛицоСсылка = Неопределено, Параметры, ОписаниеОшибки)
	...
	Иначе
		...
		Если Выборка.Количество()=0 Тогда
			...
			КонтактноеЛицо.Комментарий = НСтр("ru = 'Создан автоматически при импорте заказа с сайта'")
			+ " " + ТекущаяДатаСеанса();
...
Процедура ОбновитьКонтактнуюИнформациюКонтрагента(КонтрагентОбъект, КонтрагентXDTO, Замещать = Ложь, 
	...
	Если НЕ АдресXDTO = Неопределено 
		...
		ВидКИХранитьИсториюИзменений = ОбщегоНазначения.ЗначениеРеквизитаОбъекта( ВидКИ, "ХранитьИсториюИзменений" );
		ЗамещатьАдрес = Замещать;
		Если ЗамещатьАдрес = Ложь И ВидКИХранитьИсториюИзменений Тогда
...
//	СвойстваЗаказа - Соответствие из Произвольный - свойства загружаемого заказа
...
Процедура УстановитьСостояниеЗаказа(ДокументОбъект, СвойстваЗаказа, ТаблицаСоответствияСтатусовЗаказов, Параметры)
	...
	КонецЕсли;
	Если Не ЗначениеЗаполнено(ДокументОбъект.СостояниеЗаказа) Тогда
		ДокументОбъект.СостояниеЗаказа = РаботаСЗаявками.ПервоеСостояниеПослеЗаявки(ДокументОбъект.ВидЗаказа);
	КонецЕсли;
	Если ДокументОбъект.СостояниеЗаказа = Справочники.СостоянияЗаказовПокупателей.Завершен Тогда
...
//
// Параметры:
//	МассивЗаказов - Массив из ДокументСсылка - Массив, содержащий ссылки на заказы.
//
// Возвращаемое значение
...
// Параметры:
//	Параметры - Структура - структура, содержащая параметры обмена
//	СтруктураСтатистики - Структура - структура для записи статистики по выгрузке заказов
//
// Возвращаемое значение
...
//
// Параметры:
//	МассивИзменений - Массив из ДокументСсылка.ЗаказПокупателя - с заказами, зарегистрированными по узлу плана обмена
//	МассивЗагруженныхДокументов - Массив из ДокументСсылка.ЗаказПокупателя - только что загруженных заказов
//	Параметры - Структура - 
//
// Возвращаемое значение:
//	Массив из РезультатЗапроса - Выборка из результата запроса.
//
...
//	МассивИзменений - Массив из Произвольный - значения отбора
...
//
// Параметры:
//	ДокументXDTO - ОбъектXDTO - типа Документ
//	ПакетCML - ПакетXDTO - содержащий типы CML
//	ВыборкаДокументов - Произвольный - Выборка, содержащая данные по заказам покупателей
//	ДеревоСвойствХарактеристик - ДеревоЗначений - содержащее свойства характеристик.
//	Параметры - Структура - содержащая параметры обмена.
//
Процедура ДобавитьТоварыЗаказаXDTO(ДокументXDTO, ПакетCML, ВыборкаДокументов, ДеревоСвойствХарактеристик, Параметры)
	...
	Пока ВыборкаТоваров.Следующий() Цикл
		...
		Если ЗначениеЗаполнено(ВыборкаТоваров.СтавкаНДС) И НЕ ВыборкаТоваров.СтавкаНДС.НеОблагается Тогда
			...
			СтавкаНалогаXDTO.Наименование = Параметры.НаименованиеНалога;
			СтавкаНалогаXDTO.Ставка = ИнтеграцияСИнтернетМагазиномПовтИсп.ПолучитьПоСтавкеНДСЗначениеДляВыгрузки(ВыборкаТоваров.СтавкаНДС, ДокументXDTO.Дата);
...
//  ПакетCML - Произвольный -
//	ТоварXDTO - ОбъектXDTO - типа Товар
//	ТоварТип - Произвольный - тип объекта XDTO Товар
//	Характеристика - Произвольный - характеристика номенклатуры
//	ДеревоСвойствХарактеристик - ДеревоЗначений - содержащее свойства характеристик.
//	Параметры - Структура -
//
Процедура ВыгрузитьСвойстваХарактеристикиДляТовараXDTO(ПакетCML, ТоварXDTO, ТоварТип, Характеристика, 
	ДеревоСвойствХарактеристик, Параметры)
...
//	ДокументXDTO - ОбъектXDTO - типа Документ
//	ПакетCML - ПакетXDTO - содержащий типы CML
//	ДанныеЗаказа - Произвольный - Выборка, содержащая данные заказа покупателя
//	Параметры - Структура - содержащая параметры обмена.
//
...
Процедура ПодготовитьДанныеДляВыгрузкиТоваровЧерезСКД(Параметры)
	...
	Или ФормироватьОтчетПоДаннымДляВыгрузки Тогда
		...
		ЛогКомментарий = НСтр( "ru = 'Отбор по каталогу:'" ) + " " + КаталогПредставление
		+ ": " + ОбменСВнешнимиСистемамиЛогирование.КомментарийРазделительБлоков() 
...
Функция ПараметрыДляУслуг(Параметры)
	...
	СтрокаТаблицыКаталоговЗначение = Новый Структура;
	СтрокаТаблицыКаталоговЗначение.Вставить( "ХранилищеНастроекКомпоновки", Неопределено );
	СтрокаТаблицыКаталоговЗначение.Вставить( "Группы", Неопределено );
	СтрокаТаблицыКаталоговЗначение.Вставить( "СтруктураРезультата", СтруктураРезультата );
	СтрокаТаблицыКаталоговЗначение.Вставить( "ИдентификаторКаталога", Параметры.ИдентификаторКаталогаУслуг );
	СтрокаТаблицыКаталоговЗначение.Вставить( "Каталог, Параметры.ИдентификаторКаталогаУслуг" );
	СтрокаТаблицыКаталоговЗначение.Вставить( "ИдКаталога", Параметры.ИдентификаторКаталогаУслуг );
	
	ПараметрыДляУслуг.Вставить("СтрокаТаблицыКаталогов", СтрокаТаблицыКаталоговЗначение);
...
// Параметры:
//	Параметры - Структура - Структура, основные параметры
//	МассивПодкаталогов - Массив из Строка - Массив
//	ОписаниеОшибки - Строка
...
Функция ОтправитьФайлНаСервер(ПолноеИмяФайла, Соединение, ПараметрыЗапроса="", Заголовки="", ОписаниеОшибки, Параметры = Неопределено)
	...
	Если КодСостояния <> 200 Тогда
		...
		ДобавитьОписаниеОшибки(ОписаниеОшибки, 
		НСтр("ru = 'Получение данных с сервера: Ответ сервера:'") +" " + HTTPОтветСервера.КодСостояния);
...
Процедура ЗаписатьИнформациюПоЗаказамВТаблицуИнформации(ТаблицаИнформации, ДатаНачала, Действие, Успех, СтруктураСтатистики, ОписаниеОшибки, Параметры);
	...
	Если СайтОшибкаАвторизации <> Истина Тогда
		...
		Иначе
			...
			+ Символы.ПС + ?(Успех = Истина, 
			НСтр("ru = 'Выгружено:'"), НСтр("ru = 'Не выгружено:'") )
			+ " " + СтруктураСтатистики.Выгружено.Количество();
...
Функция ФорматИдДляXDTO(Идентификатор)
	
	Возврат Лев(Идентификатор, 40);
...
//
// Возвращаемое значение:
//      Соответствие из Произвольный - Список сокращений.
//
...
// 
// Параметры:
//  НастройкиПрокси - Соответствие из Произвольный - ключи
// НеИспользоватьПроксиДляЛокальныхАдресов - строка -
// Сервер - адрес прокси-сервера
// Порт - порт прокси-сервера
// Пользователь	- имя пользователя для авторизации на прокси-сервере
...
// 
// Возвращаемое значение:
//  ИнтернетПрокси - Сформировать прокси
...
Функция ПодготовитьZIPАрхивы(Параметры, ОписаниеОшибки)
	...
	Если (Параметры.Свойство("ИспользоватьОптимизированныйОбменКартинок")
		...
		ЗаписьАрхива.Добавить(Параметры.КаталогНаДиске + "\*.xml", 
		РежимСохраненияПутейZIP.СохранятьОтносительныеПути, РежимОбработкиПодкаталоговZIP.НеОбрабатывать);
	Иначе
		//@skip-check bsl-legacy-check-static-feature-access
		//@skip-check bsl-legacy-check-dynamic-feature-access
		ЗаписьАрхива.Добавить(Параметры.КаталогНаДиске + "\*.*", 
...
Процедура ДобавитьНастройкиВПараметры(НастройкаИнтеграции, Параметры)
	...
	|	НастройкиИнтеграции.ИспользоватьПрефиксОрганизации КАК ИспользоватьПрефиксОрганизации,
	...
	Если Не ЗначениеЗаполнено( Параметры.ТипБулевоЗначенияДляВыгрузки ) Тогда
		Параметры.ТипБулевоЗначенияДляВыгрузки = ТипБулевоЗначенияДляВыгрузкиПоУмолчанию();
	КонецЕсли;
...
//
// Параметры:
//	ТипОбъектаXDTO - ТипОбъектаXDTO - тип объекта XDTO, от которого требуется получить тип свойства
//	ИмяСвойства - Строка - имя свойства, тип которого нужно получить
//
// Возвращаемое значение:
//	ТипОбъектаXDTO.
//
...
//
// Параметры:
//	АдресXDTO - ОбъектXDTO - типа Адрес
//	ИмяПоля - Строка
//	Значение - Строка
//	ПакетCML - ПакетXDTO - содержащий типы CML.
//
...
//	МассивКоэф - Массив из Число - массив коэффициентов распределения
//	Точность - Число - точность округления при распределении.
//
// Возвращаемое значение:
//	Число - МассивСумм - массив размерностью равный массиву коэффициентов, содержит
...
Функция ОчиститьКаталог(Каталог, ОписаниеОшибки)
	...
	Исключение
		...
		ДобавитьОписаниеОшибки(ОписаниеОшибки,
		ОписаниеИсключительнойОшибки(ТекстОшибки, НСтр("ru = 'Не удалось очистить каталог обмена, п.3:'")
		+ " (" + Каталог + ")"));
...
//
// Параметры:
//	Параметры - Структура - Структура основных параметров
	...
	Иначе
		...
		Для Каждого ВыгруженныеТоварыИнтернетМагазинаСтрока Из ВыгруженныеТоварыИнтернетМагазина Цикл
			...
			Если КаталогЭлемент = Неопределено Тогда
				...
				ТаблицаКаталоговСтрока = ТаблицаКаталогов.Найти( 
				ВыгруженныеТоварыИнтернетМагазинаСтрока.ИдентификаторКаталога, "ИдентификаторКаталога" );
			...
			КаталогЭлемент.Вставить( ВыгруженныеТоварыИнтернетМагазинаСтрока.Действие, 
			ВыгруженныеТоварыИнтернетМагазинаСтрока.Количество );
...
Процедура ЗаписатьДанныеОВыгрузкеТоваров(НастройкаИнтеграции, Параметры)
	...
	Если Параметры.ВыгружатьТолькоИзменения И НЕ Параметры.ВыполнятьПолнуюВыгрузкуПринудительно Тогда
		...
		Для Каждого СтрОписание Из Параметры.ВыгруженныеОстаткиИнтернетМагазина Цикл
			МенеджерЗаписи = РегистрыСведений.ВыгруженныеОстаткиИнтернетМагазина.СоздатьМенеджерЗаписи();
			ЗаполнитьЗначенияСвойств(МенеджерЗаписи, СтрОписание);
			МенеджерЗаписи.НастройкаИнтеграцииСИнтернетМагазином = НастройкаИнтеграции;
			МенеджерЗаписи.ДатаВыгрузки = Параметры.ДатаФормирования;
			МенеджерЗаписи.Записать();
		КонецЦикла;
		
		Для Каждого СтрОписание Из Параметры.ВыгруженныеЦеныИнтернетМагазина Цикл
			МенеджерЗаписи = РегистрыСведений.ВыгруженныеЦеныИнтернетМагазина.СоздатьМенеджерЗаписи();
			ЗаполнитьЗначенияСвойств(МенеджерЗаписи, СтрОписание);
			МенеджерЗаписи.НастройкаИнтеграцииСИнтернетМагазином = НастройкаИнтеграции;
			МенеджерЗаписи.ДатаВыгрузки = Параметры.ДатаФормирования;
			МенеджерЗаписи.Записать();
	...
	Иначе
		...
		НаборЗаписей = РегистрыСведений.ВыгруженныеОстаткиИнтернетМагазина.СоздатьНаборЗаписей();
		НаборЗаписей.Отбор.НастройкаИнтеграцииСИнтернетМагазином.Установить(НастройкаИнтеграции);
		НаборЗаписей.Записать();
		Для Каждого СтрОписание Из Параметры.ВыгруженныеОстаткиИнтернетМагазина Цикл
			МенеджерЗаписи = РегистрыСведений.ВыгруженныеОстаткиИнтернетМагазина.СоздатьМенеджерЗаписи();
			ЗаполнитьЗначенияСвойств(МенеджерЗаписи, СтрОписание);
		...
		НаборЗаписей = РегистрыСведений.ВыгруженныеЦеныИнтернетМагазина.СоздатьНаборЗаписей();
		НаборЗаписей.Отбор.НастройкаИнтеграцииСИнтернетМагазином.Установить(НастройкаИнтеграции);
		НаборЗаписей.Записать();
		Для Каждого СтрОписание Из Параметры.ВыгруженныеЦеныИнтернетМагазина Цикл
			МенеджерЗаписи = РегистрыСведений.ВыгруженныеЦеныИнтернетМагазина.СоздатьМенеджерЗаписи();
	...
	Пока Категории.Следующий() Цикл
		...
		Пока ВыборкаСвойства.Следующий() Цикл
			Если ЗначениеЗаполнено(ВыборкаСвойства.Свойство) Тогда
				//@skip-check query-in-loop
				ЗаполнитьИДСайтаДляОбъектаXDTO(СвойстваXDTO, ВыборкаСвойства.Свойство,, Параметры);
			КонецЕсли;
		КонецЦикла;
	...
	Если ОбъектXDTOСодержитСвойство(КонтрагентXDTO, "Контакты") И КонтрагентXDTO.Контакты <> Неопределено Тогда
		Если ОбъектXDTOСодержитСвойство(КонтрагентXDTO.Контакты, "Контакт") 
			...
			Для Каждого КонтактXDTO Из МассивКонтактовXDTO Цикл
				...
				СтруктураКИВидНаименование = ОбщегоНазначения.ЗначениеРеквизитаОбъекта( СтруктураКИ.Вид, "Наименование");
				ДобавитьСтрокуИнформацииПоКонтрагенту(СтруктураКИВидНаименование, 
				СтруктураКИ.Тип, КонтактXDTO.Значение, ИнформацияПоКонтрагенту);
...
Функция ПолучитьКлассификаторИКаталогДляВебСервиса(ДатаИзменения, КодГруппы, КодНастройкиИнтеграции = Неопределено)
	...
	Исключение
		...
		ТекстОшибки = "ПолучитьКлассификаторИКаталогДляВебСервиса: Ошибка: КлассификаторXDTO: "
		+ ОбработкаОшибок.ПодробноеПредставлениеОшибки( ИнформацияОбОшибке() );
		ОбменСВнешнимиСистемамиЛогирование.ЗаписатьВЛог( ТекстОшибки, , Истина );
	...
	Исключение
		...
		ТекстОшибки = "ПолучитьКлассификаторИКаталогДляВебСервиса: Ошибка: КаталогXDTO: "
		+ ОбработкаОшибок.ПодробноеПредставлениеОшибки( ИнформацияОбОшибке() );
		ОбменСВнешнимиСистемамиЛогирование.ЗаписатьВЛог( ТекстОшибки, , Истина );
...
Функция ПолучитьОстаткиИЦеныДляВебСервиса(ДатаИзменения, КодГруппы, КодСклада, КодОрганизации, КодНастройкиИнтеграции = Неопределено)
	...
	Исключение
		...
		ТекстОшибки = "ПолучитьОстаткиИЦеныДляВебСервиса: Ошибка: ПакетПредложенийXDTO: "
		+ ОбработкаОшибок.ПодробноеПредставлениеОшибки( ИнформацияОбОшибке() );
		ОбменСВнешнимиСистемамиЛогирование.ЗаписатьВЛог( ТекстОшибки, , Истина );
...
Функция ПолучитьСтруктуруПараметровОбменаДляОбменаЧерезВебСервис()
	...
	СтруктураРезультата = Новый Структура("ВыгруженоТоваров,ВыгруженоКартинок,ВыгруженоПредложений", 0, 0, 0);
	СтруктураРезультата.Вставить( "ОписаниеОшибки", "" );
...
//
// Параметры:
//	МассивСсылокНаТовары - Массив из Произвольный - массив, содержащий ссылки на товары.
//	РазрешенныеТипыКартинок - Массив из Строка - содержащий разрешенные типы картинок.
//
// Возвращаемое значение:
//	ВыборкаИзРезультатаЗапроса - Выборка файлов.
//
...
Функция ИнтернетМагазинОтчетПоДаннымДляВыгрузкиПолучить( НастройкаИнтернетМагазина, ПараметрыКонтекст = Неопределено ) Экспорт
	...
	Успех = ИнтернетМагазинДанныеДляВыгрузкиПолучить( НастройкаИнтернетМагазина, ПараметрыКонтекст );
...
Функция ДиагностикаТовараВыполнить( ПараметрыКонтекст ) Экспорт
	...
	Если СохраненнаяТаблицаКаталоговДляЗаменыОсновная.Количество() = 0 Тогда
    	ОбщегоНазначения.СообщитьПользователю( "Диагностика товара: Каталоги не заданы в настройка интернет-магазина """ + НастройкаИнтернетМагазина + """" );
		Возврат Результат;
	КонецЕсли;
    ...
    Если СохраненнаяТаблицаКаталоговДляЗаменыОсновная.Количество() > 1 Тогда
		...
		Если СохраненнаяТаблицаКаталоговДляЗаменыОсновная.Количество() <> 1 Тогда
    		ОбщегоНазначения.СообщитьПользователю( "Диагностика товара: Идентификатор каталога задан некорректно." );
			Возврат Результат;
		КонецЕсли;
...
Функция ОбменДаннымиДиагностикаТовараИтерацияВыполнить( ПараметрыКонтекст = Неопределено )
	...
	ИнтернетМагазинОтчетПоДаннымДляВыгрузкиПолучить( НастройкаИнтернетМагазина, ПараметрыКонтекст );
	
	Если Не ПараметрыКонтекст.Свойство( "ОтчетПоДаннымДляВыгрузкиДанные" ) Тогда
		ОбщегоНазначения.СообщитьПользователю( "Диагностика товара: Ошибка при получении данных." );
		Возврат Результат;
	КонецЕсли;
