...
Процедура ПриДобавленииПереименованийОбъектовМетаданных(Переименования) Экспорт
	...
	ОбщегоНазначения.ДобавитьПереименование(Переименования, "1.6.25.134", "Подсистема.ДенежныеСредства",
		"Подсистема.Деньги", "УправлениеНебольшойФирмой");
	ОбщегоНазначения.ДобавитьПереименование(Переименования, "1.6.25.134", "Подсистема.ЗапасыИЗакупки",
		"Подсистема.Закупки", "УправлениеНебольшойФирмой");
	ОбщегоНазначения.ДобавитьПереименование(Переименования, "1.6.25.134", "Подсистема.ЗарплатаИПерсонал",
		"Подсистема.Персонал", "УправлениеНебольшойФирмой");
	ОбщегоНазначения.ДобавитьПереименование(Переименования, "1.6.25.134", "Подсистема.МаркетингИПродажи",
		"Подсистема.Продажи", "УправлениеНебольшойФирмой");
	ОбщегоНазначения.ДобавитьПереименование(Переименования, "1.6.25.134", "Подсистема.НалогиИОтчетность",
		"Подсистема.Налоги", "УправлениеНебольшойФирмой"); 
	
	ОбщегоНазначения.ДобавитьПереименование(Переименования, "3.0.1.31", "Роль.БазовыеПраваУНФ",
		"Роль.БазовыеПраваПриложения", "УправлениеНебольшойФирмой");
	
	ОбщегоНазначения.ДобавитьПереименование(Переименования, "3.0.1.31", "Подсистема.ОбщиеНастройкиПубликацийУНФ",
		"Подсистема.ОбщиеНастройкиПубликацийВнедрение", "УправлениеНебольшойФирмой");
	ОбщегоНазначения.ДобавитьПереименование(Переименования, "3.0.1.31", "Подсистема.ИнтеграцияГОСИСУНФ",
		"Подсистема.ИнтеграцияГОСИС", "УправлениеНебольшойФирмой");
	ОбщегоНазначения.ДобавитьПереименование(Переименования, "3.0.1.31", "Подсистема.ИнтеграцияВЕТИСУНФ",
		"Подсистема.ИнтеграцияВЕТИС", "УправлениеНебольшойФирмой");
	ОбщегоНазначения.ДобавитьПереименование(Переименования, "3.0.1.31", "Подсистема.ИнтеграцияГИСМУНФ",
		"Подсистема.ИнтеграцияГИСМ", "УправлениеНебольшойФирмой"); 
	ОбщегоНазначения.ДобавитьПереименование(Переименования, "3.0.1.31", "Подсистема.ИнтеграцияЕГАИСУНФ",
		"Подсистема.ИнтеграцияЕГАИС", "УправлениеНебольшойФирмой");
	ОбщегоНазначения.ДобавитьПереименование(Переименования, "3.0.1.31", "Подсистема.ИнтеграцияИСМПУНФ",
		"Подсистема.ИнтеграцияИСМП", "УправлениеНебольшойФирмой");
	ОбщегоНазначения.ДобавитьПереименование(Переименования, "3.0.1.31", "Подсистема.БазоваяФункциональностьИСУНФ",
		"Подсистема.БазоваяФункциональностьИСВнедрение", "УправлениеНебольшойФирмой");
	ОбщегоНазначения.ДобавитьПереименование(Переименования, "3.0.1.31", "Подсистема.ИнтеграцияРМКУНФ",
		"Подсистема.ИнтеграцияРМК", "УправлениеНебольшойФирмой");
	ОбщегоНазначения.ДобавитьПереименование(Переименования, "3.0.1.31", "Подсистема.ПодсистемыУНФ",
		"Подсистема.СлужебныеПодсистемы", "УправлениеНебольшойФирмой");
	ОбщегоНазначения.ДобавитьПереименование(Переименования, "3.0.1.31", "Подсистема.ОплатаСервисаУНФ",
		"Подсистема.ОплатаСервисаВнедрение", "УправлениеНебольшойФирмой");
	ОбщегоНазначения.ДобавитьПереименование(Переименования, "3.0.1.31", "Подсистема.ПрослеживаемостьТоваровУНФ",
		"Подсистема.ПрослеживаемостьТоваровВнедрение", "УправлениеНебольшойФирмой");
	ЭлектроннаяПочтаУНФ.ПриДобавленииПереименованийОбъектовМетаданных(Переименования);

	ОбщегоНазначения.ДобавитьПереименование(Переименования, "3.0.5.5",
		"Роль.ИспользованиеОбработкиПродажиСФулфилментомЯндекса",
...
Процедура ПриДобавленииСерверныхОповещений(Оповещения) Экспорт
	...
	// ИнтеграцияБПО
	ИнтеграцияПодсистемБПО.ПриДобавленииСерверныхОповещений(Оповещения);
	// Конец ИнтеграцияБПО
...
Процедура ЗаписатьДанныеВХранилище(Владелец, Данные, Ключ) Экспорт
	...
	ХранилищеДанных = РегистрыСведений.БезопасноеХранилищеДанных.СоздатьМенеджерЗаписи();
